...
function template_profile_theme_settings()
{
	...
	echo '
						...
						<ul id="theme_settings">
							...
							<li>
								<input type="hidden" name="default_options[use_dark_theme]" value="0" />
								<label for="show_board_desc"><input type="checkbox" name="default_options[use_dark_theme]" id="use_dark_theme" value="1"', !empty($context['member']['options']['use_dark_theme']) ? ' checked="checked"' : '', ' class="input_check" /> ', $txt['use_dark_theme'], '</label>
							</li>
							<li>
